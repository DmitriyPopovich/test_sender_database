...
abstract class AbstractDataBase{
	...
	protected function __construct($db_host, $db_user, $db_password, $db_name, $sq, $prefix){
		...
		$this->sq = $sq;
		$this->prefix = $prefix;
		$this->mysqli->query("SET lc_time_names = 'ru_ru'"); //Задать локаль как переменную из файла конфигурации, потом подставить ее!!!!
		$this->mysqli->set_charset(Config::DB_ENCODE);
	}
